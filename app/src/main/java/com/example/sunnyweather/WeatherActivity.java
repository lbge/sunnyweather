...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String weatherString = prefs.getString("weather", null);//从缓存中读取天气数据
        if (weatherString != null) {
            //有缓存时直接解析数据
            Weather weather = Utility.handleWeatherResponse(weatherString);//静态方法，可由类直接调用
    ...
    public void requestWeather(final String weatherId) {
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId +
                "&key=856c132e45eb4fe8b9b16fea4d95704b";
    ...
    public void showWeatherInfo(Weather weather) {
        ...
        forecastLayout.removeAllViews();//预报界面初始化
